...
export class VideoRepository {
    ...
    async load(): Promise<VideoItem[]> {
        try {
            ...
            this.store = await preferences.getPreferences(this.context, options);
